...
#SECRET_KEY = 'django-insecure-#9mo$rgq(flq!2wt=9+vms0=ejt=_m8w_wi3hg$_-m0++he5hw'
...
# App-level & global static directory
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Create a folder named 'static' in your project root
]

# For collectstatic (where files are gathered for production)
